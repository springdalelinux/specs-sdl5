...
%define modulesminorversion 038
%define install_dir /opt/intel/mkl/10.2.6.%{modulesminorversion}
...
Prefix: /opt/intel/mkl/10.2.6.%{modulesminorversion}
...
%post
/usr/sbin/hardlink -c %{install_dir} /opt/intel/ >/dev/null 2>&1 || :
