...
Name: %{?_name:%{_name}}%{!?_name:openmpi}010203-%{compiler}
Version: 1.2.3
Release: 2.cses.4%{?dist}
License: BSD
...
Requires: %{modules_rpm_name}
%endif
#Obsoletes: %{?_name:%{_name}}%{!?_name:openmpi}010202-%{compiler}-runtime
...
Group: Development/Libraries
Requires: %{name}-runtime torque-devel
...
%endif
#Obsoletes: %{?_name:%{_name}}%{!?_name:openmpi}010202-%{compiler}-devel
...
#Obsoletes: %{?_name:%{_name}}%{!?_name:openmpi}010202-%{compiler}-docs
