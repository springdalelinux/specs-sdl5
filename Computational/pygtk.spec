...
# RH bug #237077 / GNOME bug #347273
# Also, RH bug #430347 / GNOME bug #361439
Patch1: pygtk-2.10.1-boxed-unref-shared.patch

# RH bug #251029 / GNOME bug #380020
Patch2: pygtk2-2.10.1-install-extrafuncs.patch

### Dependencies ###

Requires: gtk2 >= 2.9.4
Requires: pycairo26
Requires: pygobject26
#Requires: python26-numeric
Requires: numpy26
Requires: python26 >= 2.3
...
BuildRequires: pycairo26-devel >= 0.5.0
BuildRequires: pygobject26-devel >= 2.12.0
#BuildRequires: python26-numeric
BuildRequires: numpy26
BuildRequires: python26-devel >= 2.3
...
Group: Development/Languages
Requires: pygtk26 = %{version}-%{release}
...
Group: Development/Languages
Requires: pygtk26 = %{version}-%{release}
Requires: pygtk26-codegen = %{version}-%{release}
Requires: pygobject26-devel
Requires: pycairo26-devel
...
%patch0 -p1
%patch1 -p1 -b .boxed-unref-shared
%patch2 -p1 -b .install-extrafuncs
...
rm -rf $RPM_BUILD_ROOT%{_libdir}/pygtk
...
%changelog
* Mon Jan 28 2008 Matthew Barnes <mbarnes@redhat.com> - 2.10.1-12.el5
- Revise patch for RH bug #237077 to correct a reference counting error.
  Reported separately as RH bug #430347.

* Mon Dec 17 2007 Matthew Barnes <mbarnes@redhat.com> - 2.10.1-11.el5
- Add patch for RH bug #251029 (install gtk-extrafuncs.defs).

* Mon Dec 17 2007 Matthew Barnes <mbarnes@redhat.com> - 2.10.1-10.el5
- Require not just pygtk2 = (version) but (version)-(release) in the
  subpackages (RH bug #311571).

* Mon Dec 17 2007 Matthew Barnes <mbarnes@redhat.com> - 2.10.1-9.el5
