...
BuildArch:      noarch
BuildRequires:  python26-devel python26-setuptools-devel
...
mv $RPM_BUILD_ROOT%{_bindir}/nosetests $RPM_BUILD_ROOT%{_bindir}/nosetests26
mv $RPM_BUILD_ROOT%{_mandir}/man1/nosetests.1 $RPM_BUILD_ROOT%{_mandir}/man1/nosetests26.1
