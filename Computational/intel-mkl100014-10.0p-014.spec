...
Summary: Intel(R) Math Kernel Library 10.0 Update 1 for Linux*
Name: intel-mkl100014
Version: 10.0p
Release: 014.2%{?dist}
License: Copyright (c) 2007 Intel Corporation
Group: Development/Libraries
Vendor: Intel Corporation
URL: http://www.intel.com/software/products/perflib
Source: intel-mkl100014-10.0p-014.noarch.rpm
BuildRoot: %{_tmppath}/%{name}-%{version}-root
AutoReqProv: 0
Requires: /bin/sh
%ifarch i386
Provides: 32/libguide.so, 32/libiomp5.so, 32/libmkl.so, 32/libmkl_core.so, 32/libmkl_def.so, 32/libmkl_gf.so, 32/libmkl_gnu_thread.so, 32/libmkl_intel.so, 32/libmkl_intel_thread.so, 32/libmkl_lapack.so, 32/libmkl_p3.so, 32/libmkl_p4.so, 32/libmkl_p4m.so, 32/libmkl_p4p.so, 32/libmkl_sequential.so, 32/libmkl_vml_def.so, 32/libmkl_vml_ia.so, 32/libmkl_vml_p3.so, 32/libmkl_vml_p4.so, 32/libmkl_vml_p4m.so, 32/libmkl_vml_p4m2.so, 32/libmkl_vml_p4p.so
%define intelbits 32
%define intellibdir 32
%endif
%ifarch x86_64
Provides: em64t/libguide.so, em64t/libiomp5.so, em64t/libmkl.so, em64t/libmkl_core.so, em64t/libmkl_def.so, em64t/libmkl_gf_ilp64.so, em64t/libmkl_gf_lp64.so, em64t/libmkl_gnu_thread.so, em64t/libmkl_intel_ilp64.so, em64t/libmkl_intel_lp64.so, em64t/libmkl_intel_sp2dp.so, em64t/libmkl_intel_thread.so, em64t/libmkl_lapack.so, em64t/libmkl_mc.so, em64t/libmkl_p4n.so, em64t/libmkl_sequential.so, em64t/libmkl_vml_def.so, em64t/libmkl_vml_mc.so, em64t/libmkl_vml_mc2.so, em64t/libmkl_vml_p4n.so
%define intelbits 64
%define intellibdir em64t
%endif
%ifarch i386 x86_64
Provides: intel-mkl100014 = 10.0p-014
%endif
...
built on nnsrei021 at Mon Dec  3 02:05:13 2007
from intel-mkl100014-10.0p-014.src.rpm with opt flags -O2
...
%endif
popd
chmod -R a+rX,u+w,og-w $RPM_BUILD_ROOT
...
mkdir -p $RPM_BUILD_ROOT%{modulesdestination}/intel-mkl/10
cat > $RPM_BUILD_ROOT%{modulesdestination}/intel-mkl/10/%{intelbits} <<ENDDEFAULT
#%Module1.0#####################################################################
##
...
%dir %{modulesdestination}/intel-mkl/10
%{modulesdestination}/intel-mkl/10/%{intelbits}
