...
Requires: boost141-date-time = %{version}-%{release}
Requires: boost141-filesystem = %{version}-%{release}
Requires: boost141-graph = %{version}-%{release}
Requires: boost141-iostreams = %{version}-%{release}
Requires: boost141-program-options = %{version}-%{release}
Requires: boost141-python = %{version}-%{release}
Requires: boost141-regex = %{version}-%{release}
Requires: boost141-serialization = %{version}-%{release}
Requires: boost141-signals = %{version}-%{release}
Requires: boost141-system = %{version}-%{release}
Requires: boost141-test = %{version}-%{release}
Requires: boost141-thread = %{version}-%{release}
Requires: boost141-wave = %{version}-%{release}
...
Requires: boost141 = %{version}-%{release}
...
Group: Development/Libraries
Requires: boost141-devel = %{version}-%{release}
Obsoletes: boost141-devel-static < 1.34.1-14
...
Group: System Environment/Libraries
Requires: boost141-devel = %{version}-%{release}
Requires: boost141-openmpi = %{version}-%{release}
Requires: boost141-openmpi-python = %{version}-%{release}
Requires: boost141-graph-openmpi = %{version}-%{release}
...
Group: System Environment/Libraries
Requires: boost141-devel = %{version}-%{release}
Requires: boost141-mpich2 = %{version}-%{release}
Requires: boost141-mpich2-python = %{version}-%{release}
Requires: boost141-graph-mpich2 = %{version}-%{release}
...
for library in $RPM_BUILD_ROOT%{_libdir}/mpich2/lib/*.so; do
  rm -f $library
...
%changelog
* Tue Mar 01 2011 Robert Scheck <robert@fedoraproject.org> 1.41.0-2
- Clarified origin of the cmake0 source tarball (#673839 #c13)
- Changed license tags according to Tom Callaway (#673839 #c21)

* Sun Jan 30 2011 Robert Scheck <robert@fedoraproject.org> 1.41.0-1
- Transformed boost-1.41.0-11 into boost141-1.41.0-1 (#673839)
