...
%{!?cluster_options: %define cluster_options --disable-heterogeneous --enable-static --enable-shared --without-slurm --disable-dlopen --with-tm=/usr --with-sge}
...
Name: %{?_name:%{_name}}%{!?_name:openmpi}010303-%{compiler}
Version: 1.3.3
Release: 22.cses.5%{?dist}
License: BSD
...
/usr/local/openmpi/%{version}/%{compiler}/%{_target_cpu}/bin/*otfinfo
%if 0%{?suse_version} || "%{?rhel}" > "4"
