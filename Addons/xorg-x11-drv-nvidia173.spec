...
Source0:       http://us.download.nvidia.com/XFree86/Linux-x86/177.82/NVIDIA-Linux-x86-%{version}-pkg1.run
Source1:       http://us.download.nvidia.com/XFree86/Linux-x86_64/177.82/NVIDIA-Linux-x86_64-%{version}-pkg2.run
Source2:       nvidia.sh
Source3:       nvidia.csh
...
Requires:        nvidia173-kmod >= %{version}
Requires(post):  nvidia173-kmod >= %{version}
...
Provides:      nvidia173-kmod-common = %{version}
