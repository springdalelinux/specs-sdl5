...
Requires: R-devel = 1:%{version}-%{release}
# libRmath-devel will pull in libRmath
Requires: libRmath-devel = 1:%{version}-%{release}
...
Group: Applications/Engineering
Requires: R-core = 1:%{version}-%{release}
...
Group: Development/Libraries
Requires: libRmath = 1:%{version}-%{release}, pkgconfig
