...
%define _without_mpc 1
%if "%{rhel}" == "4"
%define _without_lirc 1
%endif
%define _without_ladspa 1
%define _without_aalib 1
%define _without_amrnb 1
%define _without_caca 1
%define _without_vstream 1
# yes, it says without but really we will use it anyway, just external one
%define _without_live 1
%define _without_xvmc 1
...
Name: mplayer
Version: 1.0
Release: 0.42%{?rcver:.%{rcver}}%{?date:.%{date}}%{?dist}
License: GPL
...
Source0: mplayer-export-%{date}.tar.bz2
%else
Packager: Dag Wieers <dag@wieers.com>
Vendor: Dag Apt Repository, http://dag.wieers.com/apt/

Source0: mplayer-export-20090331.tar.bz2
%endif
...
# various fixes from mandriva
Patch60: mplayer-mdvconfig.patch
Patch61: MPlayer-gnome-screensaver.patch
Patch63: mplayer-1.0rc1-xv.patch 
# security fixes
Patch118: MPlayer-1.0rc1-CVE-2006-6172.patch
...
BuildRequires: gcc-c++
BuildRequires: ImageMagick libdvdnav-devel
...
%prep
%if %{?date:1}0
%setup -n mplayer-export-2009-03-31 -a 1 -q
%else
%setup -n MPlayer-%{version}%{?rcver} -a 1 -q
%endif
%patch1 -p1 -b .playlist
%patch2 -p0 -b .redhat
%patch10 -p1 -b .fribidi
%patch60 -p1 -b .mdv
%patch118 -p1 -b .cve-2006-6172
...
%changelog
* Sat Jun 16 2007 Josko Plazonic <plazonic@math.princeton.edu>
- apply security fix

* Tue Jan  9 2007 Matthias Saou <http://freshrpms.net/> 1.0-0.34.rc1try2 - 5225/dag
